...
namespace EmployeeManage.Model
{
    public class EmployeeRepo : IEmployeeRepo
    {
        ...
        public IEnumerable<EmployeeInfo> SelectEmployeeInfo()
        {
        ...
        {
            return await ValidateRecord(Id);
        }

        public async Task updateAsync(EmployeeUpdateVM model)
        {
        ...
        public EmployeeInfo GetEmployeeDetails(int Id)
        {
            var data = SelectEmployeeInfo()
                .Where(r => r.EmployeeID == Id).FirstOrDefault();
            return data;
        }

        public IEnumerable<EmployeesDocumentInfo> GetRemarkPath(int id)
        {
            return _db.TblEmployeeDocuments
        ...
        public IEnumerable<VwEmployeeDatum> GetEmployeeData()
        {
        ...
        Task<IEnumerable<EmployeeInfo>> IEmployeeRepo.SelectEmployeeInfo()
        {
